...
function App() {
  const [todos, setTodos] = useState([
    { id: 0, task: "I miss Angelo Catabay", status: "Active" },
    { id: 1, task: "I love Singing", status: "Active" },
    { id: 2, task: "I love Dancing", status: "Active" },
    { id: 3, task: "photo and video editing is my hobby", status: "Active" },
